...
let examloginmiddleware = require('../../middleware/examloginmiddleware');

router.get('/account', examloginmiddleware, function (req, res, next) {
...
router.get('/account/create', examloginmiddleware, function (req, res, next) {
  res.render('create');
});

router.post('/account', examloginmiddleware, (req, res) => {
...
router.get('/account/:id', examloginmiddleware, (req, res) => {
